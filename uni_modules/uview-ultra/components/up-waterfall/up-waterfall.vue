        ...
        methods: {
            ...
            async handleData(newData) {
                ...
                for (let i = 0; i < this.columnList.length; i++) {
                    try {
                        const rect = await this.$uGetRect(`#up-column-${i}`);
                ...
                for (let item of newData) {
                    ...
                    await this.$nextTick(async () => {
                        try {
                            const rect = await this.$uGetRect(`#up-column-${minHeightIndex}`);
                    ...
                    //         const el = this.$refs[`up-column-${minHeightIndex}`][0].children[lastIndex];
                    //         if (el) {
